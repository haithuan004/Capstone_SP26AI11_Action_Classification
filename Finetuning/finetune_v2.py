...
def main():
    ...
    if not args.no_wandb:
        try:
            ...
            wandb_run = wandb.init(
                ...
                name=f"stgcn-augmented-clip{args.clip_len}",
                config=vars(args),
                tags=["stgcn", "augmented", "balanced"],
            )
    ...
    ckpt_path = SAVE_DIR / "best_stgcn_augmented.pth"
    ...
    # Save JSON
    json_path = SAVE_DIR / "best_metrics_augmented.json"
