...
def parse_args():
    ...
    p.add_argument("--lr",           type=float, default=5e-5) # Giảm cực mạnh LR của Backbone
    p.add_argument("--lr-head",      type=float, default=2e-4) # Hạ LR của Head
...
def main():
    ...
    if not args.no_wandb:
        try:
            ...
            wandb_run = wandb.init(
                ...
                name=f"stgcn-v6-regularized",
                config=vars(args),
                tags=["stgcn", "augmented", "v5"],
            )
    ...
    ckpt_path = SAVE_DIR / "best_stgcn_v5_optimal.pth"
    ...
    # Save JSON
    json_path = SAVE_DIR / "best_metrics_v5_optimal.json"
