...
DATA_DIR = Path(r'd:\Capstone2026\Action Predict\Labeled_data\New_folder_1\extracted_data')
...
ax1.set_title('Number of Tracks per Class (Raw Data)', fontsize=14, fontweight='bold')
...
ax2.set_title('Total Frames per Class (Raw Data)', fontsize=14, fontweight='bold')
...
plt.tight_layout()
out_path = r'd:\Capstone2026\Action Predict\Labeled_data\New_folder_1\data_distribution.png'
